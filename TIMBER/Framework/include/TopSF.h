#ifndef _TIMBER_TopSF
#define _TIMBER_TopSF
#include "common.h"
#include <iostream>
#include <string>
#include <numeric>
...
class TopSF {
    ...
    public:
         ...
         */
        TopSF(std::vector<float> useSFs = {},std::vector<int> idxToCheck = {});
        /**
         ...
         * @param FatJet_phi  
         */
       std::vector<float>  eval(std::vector<float> Dijet_particleNet_TvsQCD,std::vector<float> Dijet_pt ,std::vector<float> JetSF);
/*, float genWeight);
*/
};
#endif
