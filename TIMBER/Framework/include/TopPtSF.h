#ifndef _TIMBER_TOPPTSF
#define _TIMBER_TOPPTSF
#include "common.h"
#include <iostream>
#include <string>
#include <numeric>
...
class TopPtSF {
    ...
    public:
         ...
         */
        TopPtSF(std::string _year, std::vector<int> idxToCheck = {});
        /**
         ...
         * @param FatJet_phi  
         */
       std::vector<int> eval(RVec<float> Dijet_particleNet_TvsQCD, RVec<float> Dijet_pt);
};
#endif
